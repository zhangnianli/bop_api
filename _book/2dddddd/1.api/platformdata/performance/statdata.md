...
platformdata.performance.statdata

# api请求地址

[https://api.bonree.com/](https://[api.bonree.com/net/report/taskdata]\(http://api.bonree.com/net/report/taskdata\)platformdata[/performance/]\(https://[api.bonree.com/net/report/taskdata]\(http://api.bonree.com/net/report/taskdata)platformdata/performance/statdata
...
| timeframe | string | 否 | 5 | 时间频度（查询结果的时间聚合频度，比如5分钟频度）,单位是分钟 |
| fields | string | 是 | \[city,netservice\] | 指标查询结果，可以指定计算哪些指标 |
...
```
        ...
        String url = "https://api.bonree.com/platformdata/performance/statdata";
