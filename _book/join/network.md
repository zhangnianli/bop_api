...
[https://api.bonree.com/net/network/](https://[api.bonree.com/net/report/taskdata](http://api.bonree.com/net/report/taskdata)statdata
...
-X POST
-d '{"srcRef":"1002"}‘
https://api.bonree.com/net/network/statdata
```
