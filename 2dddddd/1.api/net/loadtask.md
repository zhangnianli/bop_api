...
| dHeader | String | 是 | ROLE_NAME,MONITOR_FUN,TASK_ID | 任务状态；0-禁用，1-启用，9-结束 |
...
| 名称 | 类型 | 示例值 | 描述 |
| :--- | :--- | :--- | :--- |
| ROLE_NAME | string | 勿删长期测试qq | 任务名称 |
| URL | string | [http://www.qq.com](http://www.qq.com) | 任务地址 |
| TASK_ID | Number | 170435 | 任务ID |
| MONITOR_FUN | Number | 3 | 任务类型 |
| FLAG | Number | 1 | 任务状态 |
| START_TIME | Number | 1393603200000 | 任务起始时间 |
| END_TIME | Number | 1488211200000 | 任务结束时间 |
| PARENT_ID | Number | 340832 | 父任务ID |
| ROLE_TYPE | Number | 9 | 0任务组，1,事务，3元素组，5事务或元素组子任务，9单一任务 |
| NETENV_MON | string | 111 | 网络环境监测（111全部监测，（第1位表示DNS，第2位表示ICMP，第3位表示Tracert，1表示测试，0表示不测试）） |
